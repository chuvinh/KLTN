...
<div class="container-fluid" style="padding: 0">
	<div class="fullwidthbanner">
		...
		<div class="col-md-4" style="padding:0">
			<ul class="col-md-12" style="width: 100%;background: #f1e9de;padding-top:0px;padding-left: 10px;">
				<img src="image/banner-ao-1.jpg" alt="" height="120px" width="100%" ></a>
				<img src="image/banner-quan-1.jpg" alt="" height="120px" width="100%" style="margin-top: -2px;"></a>
				<img src="image/banner-giay-2.jpg" alt="" height="120px" width="100%" style="margin-top: -2px;"></a>
			</ul>
		</div>
	</div>
</div>
